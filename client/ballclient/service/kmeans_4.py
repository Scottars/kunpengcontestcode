...
# import copy
# from client.ballclient import numpy as np
...
def KMeans(dataSet, k):
    ...
    count=6 #这个是为了限制最多的循环的次数
    while clusterChange and count>=0:
        count = count-1
    ...
    bestlist1, bestlist2, bestlist3, bestlist4=getnoorder(clusterAssment, m, dataSet,centroids)
...
def getnoorder(clusterAssment,m,dataSet,centroids):
    a=0
    alist=[[centroids[0,0],centroids[0,1]]]
    b=0
    blist=[[centroids[1,0],centroids[1,1]]]
